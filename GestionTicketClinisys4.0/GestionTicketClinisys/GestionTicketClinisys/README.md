...
│   ├── TicketsController.cs    # Gestion des tickets (principal)
│   └── HomeController.cs       # Page d'accueil et menu
...
│   ├── Enums/                 # Énumérations
│   │   ├── TicketStatus.cs    # Statuts des tickets
│   │   ├── TicketPriority.cs  # Priorités des tickets
│   │   └── TicketType.cs      # Types de tickets
│   └── ApplicationDbContext.cs # Contexte EF
├── Views/                # Vues Razor
│   ├── Tickets/               # Vues des tickets
│   │   └── GestionDemandes.cshtml # Vue principale avec modales
│   ├── Home/                  # Vues d'accueil
│   │   ├── Index.cshtml       # Page d'accueil
│   │   └── Menu.cshtml        # Menu principal
│   └── Shared/                # Vues partagées
│       ├── _Layout.cshtml     # Layout principal
│       └── Error.cshtml       # Page d'erreur
├── wwwroot/              # Ressources statiques
│   ├── css/                   # Feuilles de style
│   │   ├── GestionDemandes.css # Styles pour la page principale
│   │   ├── Menu.css           # Styles pour le menu
